...
SerialPortThread::SerialPortThread(QObject *parent) : QObject(parent)
{
    ...
    // 接收来自SerialPort信号，SerialPort信号接SerialPortThread信号再到qml
    connect(&m_serialPort, &SerialPort::serialPorterror, this, &SerialPortThread::toQmlSerialportError);
    connect(&m_serialPort, &SerialPort::serialPortSendSuccess, this, &SerialPortThread::toQmlSerialportSendSuccess);
    m_thread->start();
}
